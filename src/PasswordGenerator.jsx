  ...
  return (
    <div className='pt-8 text-white font-bold'>
      ...
      <div className="bg-purple-800 w-[350px] shadow-2xl hover:shadow-blue-900 rounded-md p-3">
        ...
        className='bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 p-2 text-white rounded-md'>
          Generate Password
        </button>
        {password && 
          <p className='font-normal text-white mt-2'>
            Generated Password is = <span className='font-bold'>{password}</span>
          </p>
          }
      </div>
      </div>
